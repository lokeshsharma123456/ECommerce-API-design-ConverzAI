            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Thumbnail = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Dimensions_Width = table.Column<double>(type: "double", nullable: true),
                    Dimensions_Height = table.Column<double>(type: "double", nullable: true),
                    Dimensions_Depth = table.Column<double>(type: "double", nullable: true),
                    Meta_CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Meta_UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Meta_Barcode = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Meta_QrCode = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
